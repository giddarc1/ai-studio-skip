...
const SignUp = () => {
  ...
  const handleGoogleSignUp = async () => {
    try {
      ...
      toast({
        title: "Sign up failed",
        description: error.message || "Failed to sign up with Google. Please try email instead.",
        variant: "destructive",
      });
    }
  };
          ...
          <div className="text-center space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Start creating professional product photography with AI
              </p>
            </div>
          </div>
          ...
          <Card className="border-border/50 shadow-elegant">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="text-center text-xs text-muted-foreground mt-2">
                <p>
                  Note: Google sign-up requires OAuth configuration in Supabase project settings.
                </p>
              </div>
