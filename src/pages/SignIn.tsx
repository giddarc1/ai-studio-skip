          ...
          <div className="text-center space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                Sign in to your account to continue creating stunning product photography
              </p>
            </div>
          </div>
          ...
          <Card className="border-border/50 shadow-elegant">
            ...
            <CardContent className="space-y-4">
              <form onSubmit={handleSignIn} className="space-y-4">
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-gradient-to-r from-primary via-primary-glow to-accent hover:shadow-glow transition-all duration-300" 
                  disabled={isLoading}
                >
              ...
              <div className="text-center text-xs text-muted-foreground mt-2">
                <p>
                  Note: Google sign-in requires OAuth configuration in Supabase project settings.
                </p>
              </div>

              <div className="text-center text-sm">
                <span className="text-muted-foreground">Don't have an account? </span>
                <Link to="/sign-up" className="text-primary hover:text-primary/80 transition-colors font-medium">
                  Sign up
                </Link>
              </div>
            </CardContent>
